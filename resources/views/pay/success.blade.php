...
<div class="maincont">
    ...
    <div class="dingdanlist">
        <table>
            <tr>
                <td width="50%">
                    <h3>订单号：{{$res->order_no}}</h3>
                    <time>创建日期：{{date("Y-m-d H:i:s",$res->create_time)}}<br />
                    </time>
...
<div class="gwcpiao">
    <table>
        <tr>
            ...
            <td width="50%"><a href="/zhubao/alipay/{{$res->order_id}}" class="jiesuan">立即支付</a></td>
        </tr>
    </table>
</div><!--gwcpiao/-->
</div><!--maincont-->
...
<!--jq加减-->
<script src="{{asset('shop/js/jquery.spinner.js')}}"></script><script>
